...
export const RU: Record<string, string> = {
	...
	separateMobileDesc: "Хранить домашнюю страницу и её настройки отдельно для мобильных устройств.",
	...
	autoCreate: "Автосоздание",
	autoCreateDesc: "Создавать заметку, если домашняя страница не существует.",
	autoCreateWarn: "При синхронизации через неофициальные сервисы возможна перезапись данных.",
	
	openingGroup: "Открываемый режим",

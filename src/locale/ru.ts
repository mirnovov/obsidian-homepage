...
export const RU: Record<string, string> = {
	...
	separateMobileWarnPrefix: "Мобильные настройки хранятся отдельно.",
	separateMobileWarnMobile: "Изменения не повлияют на настольные устройства. Используйте настольное устройство для редактирования.",
	separateMobileWarnDesktop: "Изменения не повлияют на мобильные устройства. Используйте мобильное устройство для редактирования.",
